...
def one_input_onnx_to_trt(input_shape=(1, 3, 1920, 1080), 
    ...
    if bUseINT8Mode:
        ...
        config.int8_calibrator = calibrator_int8.MyCalibrator(calibrationDataPath, nCalibration, input_shape, int8_cache_file)
...
if __name__=="__main__":
    one_input_onnx_to_trt(input_shape=(1, 3, 224, 224), 
                          type_model="int8", 
                          calibrationDataPath="/media/hc/DataDisk/data/Rally/detect/int8_calinrator_data_224/",
                          onnx_path="./onnx_model/mobilenet_v3_small.onnx",
                          trt_path="./trt_model/mobilenet_v3_small{}.trt",
                          nCalibration = 5,
                          int8_cache_file="./int8_cache_file/mobilenet_v3_small.cache")
