...
def mecpy_gpu_tensor(trt_infer_type):
    ...
    # trt_engine = load_engine_ultrulytics("/home/hc/pycharm_ws/tensorrt_infer_hc/trt_model/yolo11n_cls_train_12_3x640_wnms_bias_int8.trt")
    trt_engine = load_engine_ultrulytics("/home/hc/pycharm_ws/tensorrt_infer_hc/trt_model/yolo11n_cls_train_12_3x640_wnms_1041_int8.trt")
