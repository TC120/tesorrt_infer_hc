...
def gpu_inference_0(img_np, bindings, context, device, stream, t_size, trt_infer_type):
    ...
    # 执行 nms
    after_infer_data = nms_postprocess(after_infer_data)
...
def mecpy_gpu_tensor(trt_infer_type):
    ...
    trt_engine = load_engine_ultrulytics("/home/hc/pycharm_ws/tensorrt_infer_hc/trt_model/yolo11n_cls_train_12_3x640_wonms_wosigmod_int8.trt")
    ...
    gpu_inference_0(img_in_np, bindings, trt_context, device, stream, tmp_size, trt_infer_type)
